...
public class RegisterPage {
	...
	private WebElement wrongPasswordWarningMessage;
	...
	@FindBy(xpath = "//div[contains(@class, 'alert-dismissible')]")
		private WebElement exsistingEmailWarningMessage;
	...
	public String retreiveWrongPasswordMessage() {
		 String display = wrongConfirmPasswordWarningMessage.getText();
		return display;
	}
	...
	public String retrieveDuplicateEmailWarningMessage() {
		String text = exsistingEmailWarningMessage.getText();
		return text;
	}
